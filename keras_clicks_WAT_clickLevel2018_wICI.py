...
trainSetFile = 'D:/forNNet/TrainSet_WAT2018_wICI.mat'
mat1 = h5py.File(trainSetFile, 'r')

x_train = mat1['trainMSNSetWICI'].value
...
testSetFile = 'D:/forNNet/TestSet_WAT2018_wICI.mat'
mat2 = h5py.File(testSetFile, 'r')
x_test = mat2['testMSNSetWICI'].value
...
model.add(Dense(512, activation='relu', input_dim=201))
model.add(Dropout(0.5))
...
model.save('D:/forNNet/WAT2018_clickLevel_wICI.h5')
# model = load_model('myModel.h5')
testOut = model.predict_classes(x_test)
probs = model.predict(x_test)

mat = spio.savemat('D:/forNNet/WAT2018_clickLevel_wICI_testOut.mat',
