...
trainSetFile = 'J:/SeaTech_NNetInput/TrainSet_SeaTech2019_binLevel_Expand.mat'
...
testSetFile = 'J:/SeaTech_NNetInput/TestSet_SeaTech2019_binLevel_Expand.mat'
...
model.add(Dense(512, activation='relu', input_dim=250))
model.add(Dropout(0.5))
...
model.save('J:/SeaTech_NNetInput/SeaTech2019_binLevel_Expand_network.h5')
# model = load_model('myModel.h5')
testOut = model.predict_classes(x_test)
probs = model.predict(x_test)

mat = spio.savemat('J:/SeaTech_NNetInput/SeaTech2019_binLevel_Expand_testOut.mat',
