...
trainSetFile = 'D:/forNNet/TrainSet_WAT2018_std_norm.mat'
mat1 = h5py.File(trainSetFile, 'r')

x_train = mat1['trainMSNSet'].value
...
testSetFile = 'D:/forNNet/TestSet_WAT2018_std_norm.mat'
mat2 = h5py.File(testSetFile, 'r')
x_test = mat2['testMSNSet'].value
...
model.save('D:/forNNet/WAT2018_clickLevel_std_norm.h5')
# model = load_model('myModel.h5')
testOut = model.predict_classes(x_test)
probs = model.predict(x_test)

mat = spio.savemat('D:/forNNet/WAT2018_clickLevel_std_norm_testOut.mat',
