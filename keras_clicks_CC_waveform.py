...
trainSetFile = 'J:/CalCOFI_Detections_All/CalCOFI_TPWS/mergeSRates_cluster_bins_95/forNNet/nnet_CC_train.mat'
...
testSetFile = 'J:/CalCOFI_Detections_All/CalCOFI_TPWS/mergeSRates_cluster_bins_95/forNNet/nnet_CC_test.mat'
...
#model.add(Dense(256, activation='relu', input_dim=421))
#model.add(Dropout(0.5))
model.add(Dense(421, activation='relu',kernel_regularizer=regularizers.l2(0.001), input_dim=421))
model.add(Dropout(0.25))
model.add(Dense(421, activation='relu',kernel_regularizer=regularizers.l2(0.001)))
model.add(Dropout(0.25))
model.add(Dense(421, activation='relu',kernel_regularizer=regularizers.l2(0.001)))
model.add(Dropout(0.25))
model.add(Dense(421, activation='relu'))
model.add(Dropout(0.25))
...
model.save('J:/CalCOFI_Detections_All/CalCOFI_TPWS/192kHz/forNNet/CC_noICI.h5')
# model = load_model('myModel.h5')
testOut = model.predict_classes(x_test)
probs = model.predict(x_test)

mat = spio.savemat('J:/CalCOFI_Detections_All/CalCOFI_TPWS/192kHz/forNNet/CC_noICI_testOut.mat',
