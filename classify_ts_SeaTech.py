...
directory = os.fsencode('J:/Arctic_C2_10/Arctic_C2_10/toClassify')
# load trained network
os.chdir(directory)
model = load_model('J:/SeaTech_NNetInput/SeaTech2019_binLevel_Expand_network.h5')
inDir ='J:/Arctic_C2_10/Arctic_C2_10/toClassify'
outDir = 'J:/Arctic_C2_10/Arctic_C2_10/toClassify/labels'
